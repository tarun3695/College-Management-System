  ...
  <div class="container">
    ...
    <div class="body">
      ...
      <div class="right-column">
        ...
        $sql = "SELECT id, profile_image, roll, name, department, year FROM student";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            echo "<table><tr><th>ID</th><th>Profile</th><th>Roll</th><th>Name</th><th>Department</th><th>Year</th></tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><img src='" . htmlspecialchars($row['profile_image']) . "' alt='Profile' width='80'></td>";
